...
\newcommand{\summaryTitle}{Model Predictive Control}
\newcommand{\summarySubTitle}{FS25 ETHZ}
\newcommand{\summaryAuthor}{Juri Pfammatter, Daniel Schweizer and Tobias Meier}
\newcommand{\repoURL}{https://github.com/meiertobias/eth-mpc}
...
\newcommand{\papersize}{a2paper} % a4paper or a3paper

...
\begin{itemize}
    ...
    \item The value function $J^*(x(k))$ is convex and piecewise linear on polyhedra.
\end{itemize}
...
where
\begin{itemize}
    \item $\Delta x$ is a desecnt direction
...
% TODO: There was a comment on a Lagrangian which I didn't understand (we don't use Lagr. multipliers (i.e. solve the primal problem?) and use just Newton's method)
